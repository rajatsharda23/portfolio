    ...
    <div className='fixed top-0 left-0 right-0 h-8 flex items-center justify-between px-4 z-10 backdrop-filter backdrop-brightness-105 backdrop-blur-3xl text-white'> 
        ...
        <div className='flex flex-row items-center justify-center space-x-1 font-Apple_Regular font-bold text-sm'>
            <div className='flex flex-row items-center space-x-1 relative px-2'>
                ...
                <div className='flex h-6 w-6 items-center justify-center overflow-auto'>
            ...
            <div className='hidden items-center justify-center h-6 custom:flex xl:w-auto sm:w-14 rounded-md px-2 p-1 relative'>
                <img src={wifi} className='h-6 relative z-50 peer/wifi' alt="Wifi icon"/> 
            ...
            <div className='hidden custom:flex items-center justify-center h-6 xl:w-auto sm:w-14 rounded-md p-1 px-2 relative '>
                <img src={search} className='h-5 relative z-50 peer/wifi' alt="Search icon"/> 
                <div className='absolute inset-0 top-0 left-0 hover:bg-slate-100 hover:opacity-50 rounded-md peer-hover/wifi:bg-slate-200 peer-hover/wifi:opacity-50' /> 
            </div>

            <div className='custom:flex hidden items-center justify-center h-6 w-10 xl:w-auto sm:w-14 rounded-md p-1 px-2 relative'>
            ...
            <div className='flex items-center justify-center h-6 xl:w-auto rounded-md px-2 p-1 mt-1 relative font-Apple_Bold '>
                {formattedDate}
                <div className='absolute inset-0 top-0 left-0 hover:bg-slate-100 hover:opacity-50 rounded-md peer-hover/wifi:bg-slate-200 peer-hover/wifi:opacity-50' /> 
            </div>
