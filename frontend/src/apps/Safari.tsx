            ...
            <div className='bg-notepadBG h-full w-full'>
                <div className='p-20 pt-10'>
                    ...
                    <div className='flex flex-row space-x-4 pt-6 items-end justify-start'>
                        <div className='font-Apple_Regular text-sm flex items-start justify-center flex-col space-y-1' onClick={() => window.open("https://github.com/rajatsharda23", "_blank")}>
                            <div className='h-11 w-11 flex items-center justify-center pl-2'>
                                <img width="96" height="96" src="https://img.icons8.com/external-tal-revivo-shadow-tal-revivo/96/000000/external-github-community-for-software-building-and-testing-online-logo-shadow-tal-revivo.png" alt="GitHub icon" />
                            </div>
                            <div>
                                Github
                            </div>
                        </div>    
                        <div className='font-Apple_Regular text-sm flex items-center justify-center flex-col space-y-1' onClick={() => window.open("https://www.linkedin.com/in/rajat-sharda-3b562622b/", "_blank")}>
                        ...
                        <div className='font-Apple_Regular text-sm flex items-center justify-center flex-col space-y-1' onClick={() => window.open("https://x.com/RajatSharda_", "_blank")}>
                            <div className='h-10 w-10'>
                        ...
                        <div className='font-Apple_Regular text-sm flex items-center justify-center flex-col space-y-1' onClick={() => window.open("https://leetcode.com/", "_blank")}>
                            <div className='h-10 w-10'>
                                <img width="96" height="96" src="https://img.icons8.com/external-tal-revivo-shadow-tal-revivo/96/external-level-up-your-coding-skills-and-quickly-land-a-job-logo-shadow-tal-revivo.png"
                                alt="Leetcode icon"/>
                            </div>
                            <div>
                                Leetcode
                        ...
                        <div className='font-Apple_Regular text-sm flex items-center justify-center flex-col space-y-1' onClick={() => window.open('mailto:rajatsharda23@gmail.com', "_blank")}>
                            <div className='h-10 w-10'>
